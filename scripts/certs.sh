...
# docker run -it --rm --name certbot -v "/certs/etc:/etc/letsencrypt" -v "/certs/lib:/var/lib/letsencrypt" -v "./certbot/www:/var/www/certbot/" certbot/certbot certonly --webroot -w /var/www/certbot -d feedo.cloudns.ph
